Ext.define('TDGUI.view.target_by_name.TargetByNameForm', {
	extend: 'Ext.form.Panel',
	alias: 'widget.TargetByNameForm',
	requires: ['TDGUI.view.dropdowns.ConceptWikiProteinLookup', 'TDGUI.view.dynamicgrid.DynamicGrid3', 'TDGUI.view.target_by_name.TargetPanel'],
