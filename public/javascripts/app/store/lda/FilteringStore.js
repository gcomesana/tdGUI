...
Ext.define('TDGUI.store.lda.FilteringStore', {
  extend: 'TDGUI.store.lda.BaseStore',
...
// TODO check for valid value for the next methods (if so), it's going to be a string really
