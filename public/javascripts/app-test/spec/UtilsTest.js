...
describe('Testing TDGUI.util.Utils for', function () {
...
//    console.log("INIT beforeEach: "+LDA.helper.LDAConstants.LDA_ASSAY_OF_ACTIVITY);
     ...
     *
     ...
     'TDGUI.util.TargetReader', 'TDGUI.store.lda.TargetPharmacologyStore',
     'TDGUI.util.TargetPharmacologyReader', 'TDGUI.controller.Viewport'
     ],
...
//      var store = Ext.create('TDGUI.store.lda.TargetPharmacologyStore');
